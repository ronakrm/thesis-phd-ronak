...
- interest in OT
	...
	- interest in computational methods
		- cite POT, other repos
	
- extending to fairness
	- subgroup fairness
	- measuring accounting is hard
-motivating to expand and develop turnkey tool
	- expand core algorithm to general fairness problems
