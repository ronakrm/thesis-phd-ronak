...
\begin{figure}
    \centering
    \includegraphics[height=0.95\textheight]{6_demd/figs/mwgan_res/mwgan-00001-images.jpg}
    \includegraphics[height=0.95\textheight]{6_demd/figs/mwgan_res/demd-00001-images.jpg}
...
\begin{figure}
    \centering
    \includegraphics[height=0.95\textheight]{6_demd/figs/mwgan_res/mwgan-00003-images.jpg}
    \includegraphics[height=0.95\textheight]{6_demd/figs/mwgan_res/demd-00003-images.jpg}
