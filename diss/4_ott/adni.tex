...
%    \includegraphics[width=0.75\columnwidth,trim={0 5.5cm 0 4.5cm},clip]{figs/brains/pos_2.png}
    ...
    \vspace{-15pt}
    \caption{\label{fig:adpos} \footnotesize Ground truth progression and prediction of gray matter probabilities in an individual from our validation set. From the left, the first three images are the ground truth images at visits 1, 2, and 3, followed by our prediction at visit 3.}
\end{figure*}
...
{\bf (A) Predicting Cognition from 3D image sequences.}
...
{\bf Results.} Figure \ref{fig:loss} (left) shows the results of this analysis.
